...
void HalDisplay::displayGrayBuffer(bool turnOffScreen, RefreshMode mode) {
  einkDisplay.displayGrayBuffer(turnOffScreen, nullptr, false, convertRefreshMode(mode));
}
...
bool HalDisplay::grayscaleNeedsBwPrime() const { return einkDisplay.grayscaleNeedsBwPrime(); }

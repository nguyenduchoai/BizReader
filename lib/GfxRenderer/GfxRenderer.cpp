...
void GfxRenderer::displayGrayBuffer(HalDisplay::RefreshMode mode) const { display.displayGrayBuffer(fadingFix, mode); }
...
bool GfxRenderer::grayscaleNeedsBwPrime() const { return display.grayscaleNeedsBwPrime(); }

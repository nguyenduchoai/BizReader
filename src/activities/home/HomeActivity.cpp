...
int HomeActivity::getMenuItemCount() const {
  int count = 5;  // File Browser, Recents, BizReader Hub, File transfer, Settings
...
void HomeActivity::render(RenderLock&&) {
  ...
  std::vector<const char*> menuItems = {tr(STR_BROWSE_FILES), tr(STR_MENU_RECENT_BOOKS), "Tiện ích BizReader",
...
void HomeActivity::onBizHubOpen() { activityManager.goToBizHub(); }

...
void ActivityManager::goToBizHub() { replaceActivity(std::make_unique<BizHubActivity>(renderer, mappedInput)); }
...
void ActivityManager::goHome(HomeMenuItem initialMenuItem) {
  if (initialMenuItem == HomeMenuItem::NONE && currentActivity) {
    ...
    } else if (activityName == "BizHub") {
      initialMenuItem = HomeMenuItem::BIZ_HUB;
